...
from athena.mlops.models import get_model, count_parameters
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="cifar10_cnn",
        choices=["cifar10_cnn", "simple_resnet"],
        help="Model architecture",
    )
    parser.add_argument(
        "--experiment", type=str, default="cifar10_baseline", help="Experiment name"
    )
    ...
    data_path = storage_config.get_storage_path("datasets") / "cifar10"
    train_dataset = datasets.CIFAR10(
        data_path, train=True, download=True, transform=transform_train
    )
    test_dataset = datasets.CIFAR10(data_path, train=False, transform=transform_test)
    ...
    with mlflow.start_run(experiment_id=experiment_id):
        ...
        mlflow.log_param("data_augmentation", "random_crop_flip")
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if test_acc > best_acc:
                ...
                checkpoint_path = checkpoint_path / f"{args.model}_best.pth"
